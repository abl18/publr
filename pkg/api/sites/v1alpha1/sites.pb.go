...
// source: api/sites/v1alpha1/sites.proto
...
import (
	...
	v1alpha1 "github.com/prksu/publr/pkg/api/users/v1alpha1"
...
type Site struct {
	...
	Owner                *v1alpha1.User       `protobuf:"bytes,4,opt,name=owner,proto3" json:"owner,omitempty"`
...
func (*Site) Descriptor() ([]byte, []int) {
	return fileDescriptor_579c54d5866925ea, []int{0}
}
...
func (m *Site) GetOwner() *v1alpha1.User {
	if m != nil {
		return m.Owner
	}
	return nil
...
func (*CreateSiteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_579c54d5866925ea, []int{1}
}
...
func (*GetSiteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_579c54d5866925ea, []int{2}
}
...
func (*DeleteSiteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_579c54d5866925ea, []int{3}
}
...
func init() {
	proto.RegisterType((*Site)(nil), "publr.sites.v1alpha1.Site")
	proto.RegisterType((*CreateSiteRequest)(nil), "publr.sites.v1alpha1.CreateSiteRequest")
	proto.RegisterType((*GetSiteRequest)(nil), "publr.sites.v1alpha1.GetSiteRequest")
	proto.RegisterType((*DeleteSiteRequest)(nil), "publr.sites.v1alpha1.DeleteSiteRequest")
}

func init() { proto.RegisterFile("api/sites/v1alpha1/sites.proto", fileDescriptor_579c54d5866925ea) }

var fileDescriptor_579c54d5866925ea = []byte{
	...
	,
}
...
func (c *siteServiceClient) CreateSite(ctx context.Context, in *CreateSiteRequest, opts ...grpc.CallOption) (*Site, error) {
	out := new(Site)
	err := c.cc.Invoke(ctx, "/publr.sites.v1alpha1.SiteService/CreateSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *siteServiceClient) GetSite(ctx context.Context, in *GetSiteRequest, opts ...grpc.CallOption) (*Site, error) {
	out := new(Site)
	err := c.cc.Invoke(ctx, "/publr.sites.v1alpha1.SiteService/GetSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *siteServiceClient) DeleteSite(ctx context.Context, in *DeleteSiteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/publr.sites.v1alpha1.SiteService/DeleteSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SiteService_CreateSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publr.sites.v1alpha1.SiteService/CreateSite",
	}
...
func _SiteService_GetSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publr.sites.v1alpha1.SiteService/GetSite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SiteService_DeleteSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publr.sites.v1alpha1.SiteService/DeleteSite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _SiteService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "publr.sites.v1alpha1.SiteService",
	...
	Metadata: "api/sites/v1alpha1/sites.proto",
}
