...
// source: api/sites/v1alpha3/sites.proto
...
type Site struct {
	...
	Owner                *v1alpha3.User       `protobuf:"bytes,4,opt,name=owner,proto3" json:"owner,omitempty"`
...
func (*Site) Descriptor() ([]byte, []int) {
	return fileDescriptor_8c787e56bf3d2139, []int{0}
}
...
func (m *Site) GetOwner() *v1alpha3.User {
	if m != nil {
		return m.Owner
	}
	return nil
...
func (*CreateSiteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8c787e56bf3d2139, []int{1}
}
...
func (*GetSiteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8c787e56bf3d2139, []int{2}
}
...
func (*DeleteSiteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8c787e56bf3d2139, []int{3}
}
...
func init() {
	proto.RegisterType((*Site)(nil), "publr.sites.v1alpha3.Site")
	proto.RegisterType((*CreateSiteRequest)(nil), "publr.sites.v1alpha3.CreateSiteRequest")
	proto.RegisterType((*GetSiteRequest)(nil), "publr.sites.v1alpha3.GetSiteRequest")
	proto.RegisterType((*DeleteSiteRequest)(nil), "publr.sites.v1alpha3.DeleteSiteRequest")
}

func init() { proto.RegisterFile("api/sites/v1alpha3/sites.proto", fileDescriptor_8c787e56bf3d2139) }

var fileDescriptor_8c787e56bf3d2139 = []byte{
	...
	0xd5, 0x83, 0x0d, 0x5d, 0x71, 0xa1, 0xe2, 0x42, 0x41, 0xdc, 0x53, 0xb8, 0x70, 0x41, 0xce, 0x76,
	...
	,
}
...
func (c *siteServiceClient) CreateSite(ctx context.Context, in *CreateSiteRequest, opts ...grpc.CallOption) (*Site, error) {
	out := new(Site)
	err := c.cc.Invoke(ctx, "/publr.sites.v1alpha3.SiteService/CreateSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *siteServiceClient) GetSite(ctx context.Context, in *GetSiteRequest, opts ...grpc.CallOption) (*Site, error) {
	out := new(Site)
	err := c.cc.Invoke(ctx, "/publr.sites.v1alpha3.SiteService/GetSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *siteServiceClient) DeleteSite(ctx context.Context, in *DeleteSiteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/publr.sites.v1alpha3.SiteService/DeleteSite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SiteService_CreateSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publr.sites.v1alpha3.SiteService/CreateSite",
	}
...
func _SiteService_GetSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publr.sites.v1alpha3.SiteService/GetSite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SiteService_DeleteSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publr.sites.v1alpha3.SiteService/DeleteSite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _SiteService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "publr.sites.v1alpha3.SiteService",
	...
	Metadata: "api/sites/v1alpha3/sites.proto",
}
