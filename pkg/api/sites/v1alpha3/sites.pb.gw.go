...
var (
	pattern_SiteService_CreateSite_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1alpha3", "sites"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SiteService_GetSite_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 2, 5, 2}, []string{"v1alpha3", "sites", "name"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SiteService_DeleteSite_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 2, 5, 2}, []string{"v1alpha3", "sites", "name"}, "", runtime.AssumeColonVerbOpt(true)))
)
