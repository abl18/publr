...
// Source: github.com/prksu/publr/pkg/api/posts/v1alpha2 (interfaces: PostServiceClient)
...
func (m *MockPostServiceClient) CreatePost(arg0 context.Context, arg1 *v1alpha2.CreatePostRequest, arg2 ...grpc.CallOption) (*v1alpha2.Post, error) {
	m.ctrl.T.Helper()
...
func (m *MockPostServiceClient) DeletePost(arg0 context.Context, arg1 *v1alpha2.DeletePostRequest, arg2 ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockPostServiceClient) GetPost(arg0 context.Context, arg1 *v1alpha2.GetPostRequest, arg2 ...grpc.CallOption) (*v1alpha2.Post, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockPostServiceClient) ListPost(arg0 context.Context, arg1 *v1alpha2.ListPostRequest, arg2 ...grpc.CallOption) (*v1alpha2.PostList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v1alpha2.PostList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPostServiceClient) SearchPost(arg0 context.Context, arg1 *v1alpha2.SearchPostRequest, arg2 ...grpc.CallOption) (*v1alpha2.PostList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockPostServiceClient) UpdatePost(arg0 context.Context, arg1 *v1alpha2.UpdatePostRequest, arg2 ...grpc.CallOption) (*v1alpha2.Post, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
