...
// Source: github.com/prksu/publr/pkg/api/sites/v1alpha2 (interfaces: SiteServiceClient)
...
func (m *MockSiteServiceClient) CreateSite(arg0 context.Context, arg1 *v1alpha2.CreateSiteRequest, arg2 ...grpc.CallOption) (*v1alpha2.Site, error) {
	m.ctrl.T.Helper()
...
func (m *MockSiteServiceClient) DeleteSite(arg0 context.Context, arg1 *v1alpha2.DeleteSiteRequest, arg2 ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockSiteServiceClient) GetSite(arg0 context.Context, arg1 *v1alpha2.GetSiteRequest, arg2 ...grpc.CallOption) (*v1alpha2.Site, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
