...
// Source: github.com/prksu/publr/pkg/api/sites/v1alpha1 (interfaces: SiteServiceClient)
...
import (
	...
	v1alpha1 "github.com/prksu/publr/pkg/api/sites/v1alpha1"
...
func (m *MockSiteServiceClient) CreateSite(arg0 context.Context, arg1 *v1alpha1.CreateSiteRequest, arg2 ...grpc.CallOption) (*v1alpha1.Site, error) {
	m.ctrl.T.Helper()
...
func (m *MockSiteServiceClient) DeleteSite(arg0 context.Context, arg1 *v1alpha1.DeleteSiteRequest, arg2 ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockSiteServiceClient) GetSite(arg0 context.Context, arg1 *v1alpha1.GetSiteRequest, arg2 ...grpc.CallOption) (*v1alpha1.Site, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
