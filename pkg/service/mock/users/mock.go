...
// Source: github.com/prksu/publr/pkg/api/users/v1alpha1 (interfaces: UserServiceClient)
...
func (m *MockUserServiceClient) CreateUser(arg0 context.Context, arg1 *v1alpha1.CreateUserRequest, arg2 ...grpc.CallOption) (*v1alpha1.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserServiceClient) DeleteUser(arg0 context.Context, arg1 *v1alpha1.DeleteUserRequest, arg2 ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) GetUser(arg0 context.Context, arg1 *v1alpha1.GetUserRequest, arg2 ...grpc.CallOption) (*v1alpha1.User, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) ListUser(arg0 context.Context, arg1 *v1alpha1.ListUserRequest, arg2 ...grpc.CallOption) (*v1alpha1.UserList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) SearchUser(arg0 context.Context, arg1 *v1alpha1.SearchUserRequest, arg2 ...grpc.CallOption) (*v1alpha1.UserList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) UpdateUser(arg0 context.Context, arg1 *v1alpha1.UpdateUserRequest, arg2 ...grpc.CallOption) (*v1alpha1.User, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
