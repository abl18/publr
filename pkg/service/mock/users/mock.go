...
// Source: github.com/prksu/publr/pkg/api/users/v1alpha3 (interfaces: UserServiceClient)
...
func (m *MockUserServiceClient) CreateUser(arg0 context.Context, arg1 *v1alpha3.CreateUserRequest, arg2 ...grpc.CallOption) (*v1alpha3.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserServiceClient) DeleteUser(arg0 context.Context, arg1 *v1alpha3.DeleteUserRequest, arg2 ...grpc.CallOption) (*empty.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) GetUser(arg0 context.Context, arg1 *v1alpha3.GetUserRequest, arg2 ...grpc.CallOption) (*v1alpha3.User, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) ListUser(arg0 context.Context, arg1 *v1alpha3.ListUserRequest, arg2 ...grpc.CallOption) (*v1alpha3.UserList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v1alpha3.UserList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserServiceClient) SearchUser(arg0 context.Context, arg1 *v1alpha3.SearchUserRequest, arg2 ...grpc.CallOption) (*v1alpha3.UserList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockUserServiceClient) UpdateUser(arg0 context.Context, arg1 *v1alpha3.UpdateUserRequest, arg2 ...grpc.CallOption) (*v1alpha3.User, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
